...
//主页的保存和取消
var body_information_saveChanges = document.getElementById("body_information_saveChanges");
var body_information_cancelChanges = document.getElementById("body_information_cancelChanges");
...
body_information_cancelChanges.onclick = function () {
...
// 提交
body_information_saveChanges.onclick = function (event) {
        ...
        axios.post(HTTPURL + '/user/update', { ...json, userName: readCookie("userName") })
            .then(function (response) {
                ...
                if (!response.data.success) {
                    ...
                    window.location.href = '../html/body_information_display.html'; // 替换为你要跳转的页面的URL
                }
            })
    }
}