function initData(date = null) {
    ...
    const data = { type: 'Volleyball', useDate: date }
...
function timeslot(even) {
    ...
    if (available == 2) {
        ...
        createCookie("payGoBack", 'volleyball_booking.html')
        location.href = `choose_ticket_number.html?1=1&dataTime=${dataTime}&dataCourt=${dataCourt}&price=${price}&type=Volleyball&date=${date}&num=${num}`
    }
}
