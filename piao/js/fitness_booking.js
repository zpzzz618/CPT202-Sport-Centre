function initData(date = null) {
    ...
    const data = { type: 'Fitness', useDate: date }
...
function timeslot(even) {
    ...
    if (available == 2) {
        ...
        createCookie("payGoBack", 'fitness_booking.html')
        location.href = `choose_ticket_number.html?1=1&dataTime=${dataTime}&dataCourt=${dataCourt}&price=${price}&type=Fitness&date=${date}&num=${num}`
    }
}
