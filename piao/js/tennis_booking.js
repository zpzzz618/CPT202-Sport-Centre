function initData(date = null) {
    ...
    const data = { type: 'Tennis', useDate: date }
...
function timeslot(even) {
    ...
    if (available == 2) {
        ...
        createCookie("payGoBack", 'tennis_booking.html')
        location.href = `choose_ticket_number.html?1=1&dataTime=${dataTime}&dataCourt=${dataCourt}&price=${price}&type=Tennis&date=${date}&num=${num}`
    }
}
